...
public class CoffeeCupProgram {
	...
	private void part1(){
		...
		//cup.drinkCoffee(40);  //This line is wrong. Unntaket er "You cant drink that much coffee!"
		cup.drinkCoffee(Math.ceil(r.nextDouble()*42));
		cup.drinkCoffee(Math.floor(r.nextDouble()*20.5));
		cup.fillCoffee(32.5);
		cup.drinkCoffee(Math.ceil(r.nextDouble()*38.9));
	...
	private void part2(){
		...
		//cup.fillCoffee(Math.ceil(r.nextDouble()*59)); //Denne linja er feil. You cant drink that much coffee
		cup.drinkCoffee(Math.ceil(r.nextDouble()*42));
